...
class AlunosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create aluno" do
    assert_difference("Aluno.count") do
      post alunos_url, params: { aluno: { : @aluno., _id: @aluno._id, id: @aluno.id, nome: @aluno.nome, turma: @aluno.turma } }
    end
  ...
  test "should update aluno" do
    patch aluno_url(@aluno), params: { aluno: { : @aluno., _id: @aluno._id, id: @aluno.id, nome: @aluno.nome, turma: @aluno.turma } }
