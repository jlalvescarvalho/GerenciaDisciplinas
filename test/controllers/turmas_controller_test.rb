...
class TurmasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create turma" do
    assert_difference("Turma.count") do
      post turmas_url, params: { turma: { : @turma., ano: @turma.ano, anoLetivo: @turma.anoLetivo, id: @turma.id, letra: @turma.letra } }
    end
  ...
  test "should update turma" do
    patch turma_url(@turma), params: { turma: { : @turma., ano: @turma.ano, anoLetivo: @turma.anoLetivo, id: @turma.id, letra: @turma.letra } }
